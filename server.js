...
const keywordMap = {
  ...
  recommend: ['recomienda una','recomendar', 'decirme','sugerir','sugieres','sugiereme', 'sugiéreme','recomiéndame','recomiendame','recomiendas','cuál puedo ver', 'cual puedo ver','dime otra', 'dime una', 'dime 1','sugiere', 'dime sobre otra','cuéntame sobre una', 'cuentame sobre una', 'cuéntame sobre otra', 'cuentame sobre otra'],
